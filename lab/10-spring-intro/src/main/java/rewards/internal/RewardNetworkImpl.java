 ...
 * use case.
 *
 * In this lab, you are going to exercise the following: - Understanding
 * internal operations that need to be performed to implement "rewardAccountFor"
 * method of the "RewardNetworkImpl" class - Writing test code using stub
 * implementations of dependencies - Writing both target code and test code
